...
python evaluation_result_full_new_prompt.py 2 5 dev_small 1 0 _prompt1 bm25
...
python evaluation_result_full_new_prompt.py 5 5 dev_small 1 0 _prompt1 bm25
...
python evaluation_result_full_new_prompt.py 10 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 10shot for trec-dl-20!'
python rag-random_kshot_prompt1.py 15 1 5 1 0 0.3 21 bm25
echo 'Finished generation for 15shot for trec-dl-21!'
python evaluation_result_full_new_prompt.py 15 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 15shot for trec-dl-20!'
