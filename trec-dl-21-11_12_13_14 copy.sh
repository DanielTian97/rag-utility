...
python evaluation_result_full_new_prompt.py 3 5 dev_small 1 0 _prompt1 bm25
...
python evaluation_result_full_new_prompt.py 4 5 dev_small 1 0 _prompt1 bm25
...
python evaluation_result_full_new_prompt.py 6 5 dev_small 1 0 _prompt1 bm25
...
python evaluation_result_full_new_prompt.py 7 5 dev_small 1 0 _prompt1 bm25
