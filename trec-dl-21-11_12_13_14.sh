...
python evaluation_result_full_new_prompt.py 14 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 14shot for trec-dl-20!'
...
python evaluation_result_full_new_prompt.py 13 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 13shot for trec-dl-20!'
...
python evaluation_result_full_new_prompt.py 12 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 12shot for trec-dl-20!'
...
python evaluation_result_full_new_prompt.py 11 5 dev_small 1 0 _prompt1 bm25
echo 'Finished bert-score evaluation for 11shot for trec-dl-20!'
